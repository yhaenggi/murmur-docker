...
# dependencies
RUN apt-get install libcap2 libzeroc-ice3.7 libprotobuf10 libgrpc3 libgrpc++1 libavahi-compat-libdnssd1 libqt5core5a libqt5network5 libqt5sql5 libqt5xml5 libqt5dbus5 -y
